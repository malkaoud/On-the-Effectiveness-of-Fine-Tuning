...
def parse_args():
    ...
    parser.add_argument('--train_file', type=str, default='./ASND_train_data_500v2.jsonl')
...
def main():
    ...
    system_prompt = "You are a news categorizing assistant. You will classify what you receive into one of these classes: politics, art-and-entertainment, human-rights-press-freedom, crime-war-conflict, sports, environment, health, science-and-technology, business-and-economy, spiritual, education, or others. Only return the classification and nothing else."
