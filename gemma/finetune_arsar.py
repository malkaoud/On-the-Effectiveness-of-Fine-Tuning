...
def main():
    ...
    system_prompt = "You are an expert in social media sarcasm detection in Arabic. Predict whether the following tweet is sarcastic or not. Return \"True\" if the tweet is sarcastic and \"False\" if it is not."
